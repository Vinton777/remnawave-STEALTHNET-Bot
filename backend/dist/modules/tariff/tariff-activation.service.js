...
import { remnaCreateUser, remnaUpdateUser, remnaGetUser, isRemnaConfigured, remnaGetUserByTelegramId, remnaGetUserByEmail, extractRemnaUuid, } from "../remna/remna.client.js";
/**
 ...
 */
export async function activateTariffForClient(client, tariff) {
    ...
    if (client.remnawaveUuid) {
        ...
        if (!existingUuid)
            return { ok: false, error: "Ошибка создания пользователя VPN", status: 502 };
 ...
 */
export async function activateTariffByPaymentId(paymentId) {
...
//# sourceMappingURL=tariff-activation.service.js.map