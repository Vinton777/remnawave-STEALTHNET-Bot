...
import { verifyPassword, signAccessToken, signRefreshToken, verifyToken, hashPassword, } from "./auth.service.js";
...
authRouter.post("/refresh", async (req, res) => {
    ...
    const accessToken = signAccessToken({ adminId: stored.admin.id, email: stored.admin.email }, env.JWT_SECRET, env.JWT_ACCESS_EXPIRES_IN);
    return res.json({
        accessToken,
        expiresIn: env.JWT_ACCESS_EXPIRES_IN,
        admin: {
